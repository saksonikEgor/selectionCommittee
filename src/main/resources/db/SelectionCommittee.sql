...
INSERT INTO `enrollee` (enrollee_id, name_enrollee, password, email, passport_number, certificate_number, statement_number, photo_number, benefit_number, army_number, medition_number, phone_number)
